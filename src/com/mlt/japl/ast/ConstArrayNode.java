    ...
    public ConstArrayNode(List<AstNode> nodes) {
        ...
        if (totalLen == totalIntZerosOnes) {
            ...
            for (AstNode n : nodes) {
                ...
                else if (x.isInteger()) cell = new IntScalar(x.getInt());
                else if (x.isCharConstant()) cell = new CharScalar(x.getChar());
                else if (x.isComplex()) cell = x.getAsCell();
                else if (x.isStringConstant()) cell = new CharArray(x.getString());
                data[i++] = cell;
            }
